...
void enter_mode( int mode)
{
	...
	*/
	...
	switch(mode)
	{
		...
		case SOURCE_SELECT_HDMI:
			//printf(">>>>>>>>>> hdmi mode <<<<<<<<<<\n");
            zhuque_bsp_gpio_set_mode(12, GPIO_IN, PULLING_NONE);
			sl_ui_set_reqrate();
			//zhuque_bsp_gpio_set_mode(12, GPIO_IN, PULLING_NONE);
			usleep(1000);
...
void exit_mode( int mode)
{
	...
	switch(mode)
	{
		...
		case SOURCE_SELECT_HDMI:
			...
			zhuque_bsp_gpio_set_mode(12, GPIO_OUT, PULLING_NONE);
