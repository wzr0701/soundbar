...
*******************************************************************************/
#define SMSTART_VAL                     0x0e//10
#define HCCSTART_VAL                    0x14//13
...
extern unsigned char   qn8035_seek(unsigned int freq);
extern unsigned char qn8035_online(void);
extern void qn8035_unmute(void);
extern void qn8035_mute(void);
extern void qn8035_off(void);
extern void qn8035_set_vol(unsigned char volume);

extern void QND_WriteReg(unsigned char adr, unsigned char value);
extern unsigned char QND_ReadReg(unsigned char adr);
extern void  QND_TuneToCH(unsigned int ch);
extern void   QND_RXConfigAudio(unsigned char option) ;
extern void   QND_RXSetTH(unsigned char th);
extern unsigned char   QND_RXValidCH(unsigned int freq);
