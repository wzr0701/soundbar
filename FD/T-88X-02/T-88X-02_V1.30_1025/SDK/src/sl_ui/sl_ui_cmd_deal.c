...
void set_echo_vol(int vol)
{
	...
	else
	{
		...
		int set_echo[7] = {1, -600, 200, 0, 0, 1, 255}; //锟斤拷锟斤拷锟斤拷
		...
		int set_revb[10] = {50, 50, 2, 20, 500, 14000, -9, -6, 90, 2}; //锟斤拷锟斤拷锟斤拷
...
{
	/*瑙ute鍚巓pt/coa绛夋ā寮忎細鏈?绉掆�滃摟鈥濈殑鍣０锛岃Вmute涓嶇珛鍗冲嚭澹伴煶锛?	  寤舵椂1绉掑啀鍑哄０闊炽�?	*/
	#if 1
	set_adc_channel_vol(0,0);
