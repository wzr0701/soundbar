...
static void silan_platform_init(void)
{
    ...
    REG32(KSEG1(SILAN_PADMUX_CTRL)) |= ((1 << SILAN_PADMUX_IISADC_FD0)
                                        | (1 << SILAN_PADMUX_IISADC) |(1 << SILAN_PADMUX_IISDAC_FD0)|(1 << SILAN_PADMUX_IISDAC));
    //REG32(KSEG1(SILAN_PADMUX_CTRL)) |= ((1 << SILAN_PADMUX_SPDIF) | (1 << SILAN_PADMUX_SPDIF_IN0)
    //                                    | (1 << SILAN_PADMUX_SPDIF_IN1)); (1 << SILAN_PADMUX_IISDAC_MCLK)|
    REG32(KSEG1(SILAN_PADMUX_CTRL)) |= ((1 << SILAN_PADMUX_SPDIF_IN0) | (1 << SILAN_PADMUX_SPDIF_IN1));
...
//#ifdef CONFIG_SC6138_I2C2
    ...
    value &= ~((1 << SILAN_PADMUX_UART3_2)|(1 << SILAN_PADMUX_IISADC_FD1)|(1 << SILAN_PADMUX_IISADC_FD2));
...
//  value |= (1<<18) | (1<<16);
	...
	//P1.23 RGB:G	  low enable
	value = REG32(KSEG1(SILAN_PADMUX_CTRL));
	value &= ~(1 << SILAN_PADMUX2_SPDIF_IN1_CH2);
	REG32(KSEG1(SILAN_PADMUX_CTRL)) = value;
	value = REG32(KSEG1(SILAN_PADMUX_CTRL2));
	value &= ~(1 << SILAN_PADMUX2_PWM1);
	REG32(KSEG1(SILAN_PADMUX_CTRL2)) = value;
	...
	//BT:Blue
	zhuque_bsp_gpio_set_mode(22, GPIO_OUT, PUSH_PULL);
    zhuque_bsp_gpio_set_value(22, 1);
    zhuque_bsp_gpio_set_mode(23, GPIO_OUT, PUSH_PULL);
	zhuque_bsp_gpio_set_value(23, 1);
    zhuque_bsp_gpio_set_mode(42, GPIO_OUT, PUSH_PULL);
	zhuque_bsp_gpio_set_value(42, 0);
