#ifndef  __SILAN_CEC_H__
#define  __SILAN_CEC_H__
#include <sys/time.h>
...
enum
{
    CEC_SYSTEM_AUDIO_MODE_STATUS_ON  = 0x01,
    CEC_SYSTEM_AUDIO_MODE_STATUS_OFF = 0x00,
};
...
enum
{
	...
	CEC_CMD_POWERON = 2,
       CEC_CMD_STANDBY = 3,
       CEC_CMD_ARC_INIT= 4,
       CEC_CMD_SDB_ADJ_TV_VOL=5,
       CEC_CMD_SDB_MUTE_TV=6,
       CEC_CMD_SDB_UNMUTE_TV=7,
};
...
typedef struct
{
	...
	int powerstatus;
    int system_audio_mode_status;
} GPIO_Cec_t;

#if 1//DEBUG
#define CECDBG printf
#else
#define CECDBG
#endif

extern void cec_process_cmd(int cmd, void *data);
